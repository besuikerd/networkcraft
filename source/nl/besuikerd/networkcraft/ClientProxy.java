...
public class ClientProxy extends CommonProxy{
	...
	public void registerGuis(GuiHandlerBesu handler) {
		GuiHandlerBesu.getInstance().registerGui(GuiId.INVENTORYTEST, TileEntityTestInventory.GuiTileEntityTestInventory.class, ContainerBesuWithPlayerInventory.class);
	}
}
